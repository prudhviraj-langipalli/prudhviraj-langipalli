...
<!-- Animated Banner -->
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:0f0c29,50:302b63,100:24243e&height=200&section=header&text=Hey%2C%20I'm%20a%20DevOps%20%26%20Automation%20Engineer%20👋&fontSize=26&fontColor=ffffff&animation=fadeIn&fontAlignY=38&desc=Building%20pipelines%20that%20ship%20fast%20%7C%20Infrastructure%20that%20scales%20%7C%20Automation%20that%20never%20sleeps&descAlignY=60&descSize=14" />

<!-- Typing SVG -->
<a href="https://git.io/typing-svg">
  <img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=22&pause=1000&color=58A6FF&center=true&vCenter=true&width=700&lines=🚀+Automating+Everything+in+Sight;⚙️+CI%2FCD+Pipeline+Architect;☁️+AWS+Cloud+Infrastructure+Engineer;🐳+Kubernetes+%26+Container+Enthusiast;🏗️+Terraform+%7C+IaC+Practitioner" alt="Typing SVG" />
</a>
...
currently_working_on: "Scalable GitOps workflows & self-healing infrastructure"
philosophy: "If you're doing it twice, automate it. If it's manual, it's broken."
```
...
| 🚀 Domain | 🔧 What I Do |
|---|---|
| **CI/CD Pipelines** | Design blazing-fast, multi-stage pipelines with zero-downtime deployments |
| **Infrastructure as Code** | Terraform modules for repeatable, version-controlled cloud environments |
| **Kubernetes** | Deploy, scale, and manage containerized workloads across clusters |
| **AWS Architecture** | Design cost-optimized, highly-available cloud solutions |
| **Automation** | Script away the toil — from provisioning to incident response |
| **GitOps** | Declarative, Git-driven deployment workflows with ArgoCD |
...
> *"Automate the boring. Engineer the extraordinary. Ship with confidence."*
